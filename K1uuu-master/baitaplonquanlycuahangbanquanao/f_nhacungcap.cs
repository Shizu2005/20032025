...
namespace baitaplonquanlycuahangbanquanao
{
    public partial class f_nhacungcap : Form
    {
        ...
        {
            ham.loadgridview("v_NhaCungCap", dataGridView1);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = $"INSERT INTO v_NhaCungCap (sMaNCC, sTenNCC, sDiaChi, sSDT, sEmail) VALUES " +
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string sql = $"SELECT * FROM v_NhaCungCap WHERE MaNhaCungCap = '{maNCC}'";

            DataTable dt = new DataTable();
            using (SqlConnection cnn = new SqlConnection(ham.constr))
            {
